...
public class Create extends SqlParser {
    ...
    public Create pk(String fieldName, boolean auto) {
        fields.put(fieldName, PK_AUTO);
        return this;
    }

    public Create unique(String fieldName) {
        fields.put(fieldName, UNIQUE);
        return this;
    }
    ...
    public Create indexUnique(String name, String... fields) {
        String ind = String.format(CREATE_UNIQUE_INDEX, name, tableName, Utils.breakArray(",", fields));
        indexes.add(ind);
        return this;
    }
