...
public class Utils {
    ...
    public static String breakList(String divider, List<String> list, List<String> values) {

        String result = breakList(divider, list);

        return String.format(result,values.toArray(new String[values.size()]));
    }
